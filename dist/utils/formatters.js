...
exports.formatMessageSummary = formatMessageSummary;
exports.formatActivityRanking = formatActivityRanking;
...
function formatMessageSummary(summary, userDetails) {
...
function formatActivityRanking(users, count, mostActive, page = 1, totalUsers = users.length) {
    const pageSize = config_1.default.defaults.pageSize;
...
async function sendLongMessage(channel, text, components) {
